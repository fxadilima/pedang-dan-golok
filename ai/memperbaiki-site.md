...

        {
            links.length === 0 ? (
                ...
                links.map((link) => (
                    <a
                        href={link.href}
                        class="w3-bar-item w3-btn w3-hover-black w3-padding-large"
                    >
                        <i class="fa fa-book w3-xxlarge" />
                        <p>{link.text}</p>
                    </a>
                ))
            )
        ...
        >
...

            {
                links.length === 0 ? (
                    ...
                    links.map((link) => (
                        <a href={link.href} class="w3-bar-item w3-btn">
                            <i class="fa fa-book" /> {link.text}
                        </a>
                    ))
                )
            }
